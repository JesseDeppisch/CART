...
// Brake deadzone specifically
const int B_DEADZONE = 300;  // Deadzone (in PWM [units?]) for actuation  
*/
...
/*
// FOR PIXHAWK // TODO - which one is correct? I think this one is wrong, although I'm not sure. Remove the incorrect one, please!!
const int DEADZONE = 100;  // Deadzone (in PWM [units?]) for actuation  
...
const int RECEIVER = 11;    // Pin to receive signal from receiver, 
...
const int RECEIVER_LOW = 9;   // Receiver input: Button, binary
const int RECEIVER_HIGH = 11; // Receiver input: Trigger, - to + range
    
// For the brake, RC stuff
float RC_button = 0;       // From button

// Calibration for the RC button (very simple)
