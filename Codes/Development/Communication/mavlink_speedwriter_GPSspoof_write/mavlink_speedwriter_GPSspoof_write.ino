/**
   ...
   The GPS packet is spoofed by writing the message #124: GPS2_RAW
   ...
   Or use #103: VISION_SPEED_ESTIMATE (not sure how to transform ours into X,Y,Z
   (maybe get norm vector from GLOBAL_POSITION_INT)
...
void loop() {
  ...
  */
  ...
  ////// TESTING ///// TESTING ///// TESTING ///// TESTING /////////////////////// TODO remove
  // Trying out sending my own message
